...
// Generated using ACDS version 13.0sp1 232 at 2026.05.12.11:46:26
...
module embedded_system (
	...
	embedded_system_Onchip_memory onchip_memory (
		.clk         (clk),                                                        //   clk1.clk
	...
	embedded_system_Interval_timer interval_timer (
		.clk        (clk),                                                         //   clk.clk
	...
	embedded_system_Red_LEDs red_leds (
	...
	embedded_system_Green_LEDs green_leds (
		.clk        (clk),                                                                             //                clock_reset.clk
		.reset      (rst_controller_reset_out_reset),                                                  //          clock_reset_reset.reset
	...
	embedded_system_HEX3_HEX0 hex3_hex0 (
		.clk        (clk),                                                                            //                clock_reset.clk
		.reset      (rst_controller_reset_out_reset),                                                 //          clock_reset_reset.reset
	...
	embedded_system_Slider_switches slider_switches (
		.clk        (clk),                                                                                  //                clock_reset.clk
		.reset      (rst_controller_reset_out_reset),                                                       //          clock_reset_reset.reset
	...
	embedded_system_Pushbuttons pushbuttons (
		.clk        (clk),                                                                              //                clock_reset.clk
		.reset      (rst_controller_reset_out_reset),                                                   //          clock_reset_reset.reset
	...
	embedded_system_Expansion_JP1 expansion_jp1 (
		.clk        (clk),                                                                                //                clock_reset.clk
		.reset      (rst_controller_reset_out_reset),                                                     //          clock_reset_reset.reset
	...
	embedded_system_Expansion_JP2 expansion_jp2 (
		.clk        (clk),                                                                                //                clock_reset.clk
		.reset      (rst_controller_reset_out_reset),                                                     //          clock_reset_reset.reset
	...
	embedded_system_Serial_port serial_port (
		.clk        (clk),                                                                      //        clock_reset.clk
		.reset      (rst_controller_reset_out_reset),                                           //  clock_reset_reset.reset
	...
	reg16_avalon_interface reg16_avalon_interface_0 (
		...
		.resetn     (~cpu_jtag_debug_module_reset_reset),                                                //     reset_sink.reset_n
	...
	embedded_system_addr_router addr_router (
	...
	embedded_system_addr_router_001 addr_router_001 (
	...
	embedded_system_id_router id_router (
	...
	embedded_system_id_router_001 id_router_001 (
	...
	embedded_system_id_router_002 id_router_002 (
	...
	embedded_system_id_router_002 id_router_003 (
	...
	embedded_system_id_router_004 id_router_004 (
	...
	embedded_system_id_router_004 id_router_005 (
	...
	embedded_system_id_router_004 id_router_006 (
	...
	embedded_system_id_router_004 id_router_007 (
	...
	embedded_system_id_router_004 id_router_008 (
	...
	embedded_system_id_router_004 id_router_009 (
	...
	embedded_system_id_router_004 id_router_010 (
	...
	embedded_system_id_router_004 id_router_011 (
	...
	embedded_system_id_router_004 id_router_012 (
	...
	embedded_system_id_router_004 id_router_013 (
	...
	embedded_system_id_router_004 id_router_014 (
	...
	embedded_system_id_router_015 id_router_015 (
	...
	embedded_system_cmd_xbar_demux cmd_xbar_demux (
		.clk                (clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),    // clk_reset.reset
	...
	embedded_system_cmd_xbar_demux_001 cmd_xbar_demux_001 (
		.clk                 (clk),                                    //       clk.clk
		.reset               (rst_controller_reset_out_reset),         // clk_reset.reset
	...
	embedded_system_cmd_xbar_mux cmd_xbar_mux (
		.clk                 (clk),                                   //       clk.clk
		.reset               (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	embedded_system_cmd_xbar_mux cmd_xbar_mux_002 (
		.clk                 (clk),                                   //       clk.clk
		.reset               (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	embedded_system_cmd_xbar_mux cmd_xbar_mux_003 (
		.clk                 (clk),                                   //       clk.clk
		.reset               (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	embedded_system_rsp_xbar_demux rsp_xbar_demux (
		.clk                (clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),    // clk_reset.reset
	...
	embedded_system_rsp_xbar_demux_001 rsp_xbar_demux_001 (
		.clk                (clk),                                   //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	embedded_system_rsp_xbar_demux rsp_xbar_demux_002 (
		.clk                (clk),                                   //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	embedded_system_rsp_xbar_demux rsp_xbar_demux_003 (
		.clk                (clk),                                   //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	embedded_system_rsp_xbar_demux_001 rsp_xbar_demux_004 (
		.clk                (clk),                                   //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	embedded_system_rsp_xbar_demux_001 rsp_xbar_demux_005 (
		.clk                (clk),                                   //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	embedded_system_rsp_xbar_demux_001 rsp_xbar_demux_006 (
		.clk                (clk),                                   //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	embedded_system_rsp_xbar_demux_001 rsp_xbar_demux_007 (
		.clk                (clk),                                   //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	embedded_system_rsp_xbar_demux_001 rsp_xbar_demux_008 (
		.clk                (clk),                                   //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	embedded_system_rsp_xbar_demux_001 rsp_xbar_demux_009 (
		.clk                (clk),                                   //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	embedded_system_rsp_xbar_demux_001 rsp_xbar_demux_010 (
		.clk                (clk),                                   //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	embedded_system_rsp_xbar_demux_001 rsp_xbar_demux_011 (
		.clk                (clk),                                   //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	embedded_system_rsp_xbar_demux_001 rsp_xbar_demux_012 (
		.clk                (clk),                                   //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	embedded_system_rsp_xbar_demux_001 rsp_xbar_demux_013 (
		.clk                (clk),                                   //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	embedded_system_rsp_xbar_demux_001 rsp_xbar_demux_014 (
		.clk                (clk),                                   //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	embedded_system_rsp_xbar_demux_001 rsp_xbar_demux_015 (
		.clk                (clk),                                   //       clk.clk
		.reset              (cpu_jtag_debug_module_reset_reset),     // clk_reset.reset
	...
	embedded_system_rsp_xbar_mux rsp_xbar_mux (
		.clk                 (clk),                                   //       clk.clk
		.reset               (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	embedded_system_rsp_xbar_mux_001 rsp_xbar_mux_001 (
		.clk                  (clk),                                   //       clk.clk
		.reset                (rst_controller_reset_out_reset),        // clk_reset.reset
