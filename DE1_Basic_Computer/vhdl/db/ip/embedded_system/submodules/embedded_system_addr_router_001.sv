...
(
    ...
    localparam PAD1 = log2ceil(64'h800002 - 64'h800000); 
    localparam PAD2 = log2ceil(64'h8080000 - 64'h8000000); 
    ...
    localparam PAD11 = log2ceil(64'h10000080 - 64'h10000070); 
    localparam PAD12 = log2ceil(64'h10001008 - 64'h10001000); 
    localparam PAD13 = log2ceil(64'h10001018 - 64'h10001010); 
    ...
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h10002020;
    ...
    // ( 0x9000000 .. 0x9002000 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 29'h9000000   ) begin
    ...
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 29'h10001000   ) begin
            src_channel = 16'b000000000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 5;
    end

    // ( 0x10001010 .. 0x10001018 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 29'h10001010   ) begin
